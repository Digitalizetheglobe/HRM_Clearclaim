...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Relieve Type') }}</li>
@endsection

@section('action-button')
    @can('Create Termination Type')
        <a href="#" data-url="{{ route('terminationtype.create') }}" data-ajax-popup="true"
            data-title="{{ __('Create New Employee Exit Type') }}" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
