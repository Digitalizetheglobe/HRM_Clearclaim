                        ...
                        <ul class="nav nav-tabs mb-0" id="statusTabs">
                            <li class="nav-item">
                                <a class="nav-link {{ $status == 'Approved' ? 'active' : '' }}" 
                                   href="{{ route('attendance.request', ['status' => 'Approved', 'month' => request('month')]) }}">
                                    {{ __('Approved') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $status == 'Pending' ? 'active' : '' }}" 
                                   href="{{ route('attendance.request', ['status' => 'Pending', 'month' => request('month')]) }}">
                                    {{ __('Pending') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ ($status == 'Rejected' || $status == 'Reject') ? 'active' : '' }}" 
                                   href="{{ route('attendance.request', ['status' => 'Rejected', 'month' => request('month')]) }}">
                                    {{ __('Rejected') }}
                                </a>
                            </li>
                        </ul>

                        <form method="GET" action="{{ route('attendance.request') }}" class="d-flex align-items-center gap-2" id="attendanceRequestMonthFilterForm">
                            ...
                            @if(request('month'))
                                <a href="{{ route('attendance.request', ['status' => $status]) }}" class="btn btn-sm btn-danger text-nowrap" title="{{ __('Reset Filter') }}">
