...
<div class="navbar-wrapper">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="b-brand">
            ...
            ?>
            <img src="<?php echo e($final_logo_path); ?>?v=<?php echo e(time()); ?>"
                alt="<?php echo e(config('app.name', 'HRMGo')); ?>" 
                class="logo logo-lg" 
                style="height: 75px;"
                onerror="console.error('Logo failed to load: <?php echo e($final_logo_path); ?>'); this.onerror=null; this.src='<?php echo e(asset('storage/uploads/logo/logo-dark.png')); ?>?v=<?php echo e(time()); ?>';">
        </a>
    </div>
    <div class="navbar-content">
        ...
        <?php endif; ?>
            ...
            <li class="dash-item <?php echo e(Request::segment(1) == 'expenses' ? 'active' : ''); ?>">
                <a href="<?php echo e(route('expenses.index')); ?>" class="dash-link text-white hover:text-white hover:bg-[#001a3b] text-lg flex items-center space-x-2">
                <span class="dash-micon text-white text-[30px] shadow-none" style="background: none;">
                <i class="fas fa-receipt text-white text-[30px]"></i></span>
                    <span class="dash-mtext"><?php echo e(__('Expenses')); ?></span>
                </a>
            </li>
...
<?php /**PATH D:\HRM_Clearclaim\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>