            ...
            <div class="col-12 mb-">
                <div class="row align-items-top">
                    <div class="col-md-8">
                        ...
                        ?>
                        <h2 class="mb-2" style="font-size: 25px; font-weight: bold; color:rgb(0, 190, 92);"><?php echo e($greeting); ?>, <?php echo e($firstName); ?>!</h2>
                        <p class="mb-0" style="font-size: 16px; color: #6b7280;">
                            You have <?php echo e($pendingLeaveCount ?? 0); ?> leave request<?php echo e($pendingLeaveCount != 1 ? 's' : ''); ?> pending.
                        </p>
                    </div>
                    <div class="col-md-4 d-flex justify-content-end">
                        <div class="card" style="border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); background-color: #f8f9fa; min-width: 280px;">
                            <div class="card-body p-3">
                                    ...
                                    <p class="mb-0" id="currentDateTime" style="font-size: 18px; font-weight: bold; color: #374151; margin: 0;"><?php echo e(\Carbon\Carbon::now()->format('M d, Y, h:i:s A')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div id="punchInOutSection" class="text-center mb-4 pb-3 border-bottom">
                                            <p id="attendanceStatus" class="font-bold mb-3">
                                                    ...
                                                    <?php elseif($employeeAttendance->clock_out == '00:00:00' || !$employeeAttendance->clock_out): ?>
                                                        ...
                                                        ?>
                                                        <span class="<?php echo e($isLate ? 'text-danger' : 'text-success'); ?>"><i class="fas fa-fingerprint"></i> Punched In at <?php echo e(\Carbon\Carbon::parse($employeeAttendance->clock_in)->format('h:i A')); ?></span>
                                                    <?php else: ?>
                                                ...
                                                <?php echo e(Form::open(['url' => 'attendanceemployee/attendance', 'method' => 'post', 'id' => 'attendanceForm'])); ?>
                                                    ...
                                                    <button type="submit" value="0" name="in" id="clock_in" class="btn btn-primary btn-lg"><?php echo e(__('Punch In')); ?></button>
                                                    <?php else: ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php elseif($todo->priority == 2): ?>
                                                                    <span class="badge bg-success"><?php echo e(__('Medium')); ?></span>
                                                                <?php else: ?>
                        ...
                        <div class="card">
                                    <div class="card-header card-body table-border-style d-flex flex-wrap justify-content-between align-items-center">
                                        <h5 class="mb-2 mb-md-0" style="font-size:20px; color:black; margin: 0;">
                                            <?php echo e(__('Employees On Leave')); ?>
    ...
    function get_data() {
        ...
        $.ajax({
            ...
            success: function(data) {
                <?php if(isset($emp) && isset($attendanceData)): ?>
                    var attendanceData = <?php echo json_encode($attendanceData, 15, 512) ?>;
                    var employeeId = <?php echo e($emp->id); ?>;
                <?php else: ?>
                    var attendanceData = {};
                    var employeeId = null;
                <?php endif; ?>
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            setTimeout(function() {
                                ...
                                attendanceForm.innerHTML = '<button type="button" value="1" name="out" id="clock_out" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmClockOutModal"><?php echo e(__("Punch Out")); ?></button>';
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        setTimeout(function() {
                            ...
                            attendanceForm.innerHTML = '<button type="submit" value="0" name="in" id="clock_in" class="btn btn-primary" disabled><?php echo e(__("Punch In")); ?></button>';
                        }, 1500);
                    } else {
                        attendanceStatus.innerHTML = '<span class="text-danger"><i class="fas fa-exclamation-circle"></i> ' + data.message + '</span>';
                    }
...
function loadAttendanceData(filterType, dateValue = null) {
    ...
    const url = '<?php echo e(route("attendance.overview")); ?>';
    const payload = {
        _token: '<?php echo e(csrf_token()); ?>',
        filter_type: filterType,
        employee_id: <?php echo e($emp->id ?? 0); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HRM_Clearclaim\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>