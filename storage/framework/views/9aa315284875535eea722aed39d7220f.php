<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Off-Boarding Steps')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Off-Boarding Steps')); ?></li>
<?php $__env->stopSection(); ?>
                    ...
                    a('[data-plugin="dragula"]').each(function() {
                        ...
                        r ? dragula(n, {
                            ...
                            $("#" + target.id).parent().find('.count').text($("#" + target.id +
                                " > div").length);
                            $.ajax({
                                url: '<?php echo e(route('offboarding.order')); ?>',
                                type: 'POST',
                                data: {
                                    order: order,
                                    stage_id: stage_id,
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2" id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['offboarding.index'], 'method' => 'get', 'id' => 'offboarding_filter'])); ?>
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        ...
                                        <a href="<?php echo e(route('offboarding.index')); ?>" class="btn btn-sm btn-danger"
                                            ...
                                            <h5>
                                                <?php if($process->employee): ?>
                                                    <?php if($stage->order == 1): ?>
                                                        <a href="<?php echo e(route('resignation.index')); ?>" class="process-link">
                                                            <?php echo e($process->employee->name); ?>

                                                        </a>
                                                    <?php elseif($stage->order == 5): ?>
                                                        <a href="<?php echo e(route('termination.index')); ?>" class="process-link">
                                                            <?php echo e($process->employee->name); ?>

                                                        </a>
                                                    <?php elseif($stage->order == 6): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="#" 
                                                            data-url="<?php echo e(route('offboarding.step', ['id' => $process->id, 'step' => $stage->order])); ?>"
                                                        ...
                                                        <?php if($stage->order == 1): ?>
                                                            <a href="<?php echo e(route('resignation.index')); ?>"
                                                                class="dropdown-item"><i
                                                                    ...
                                                                    class="ms-2"><?php echo e(__('View Resignation')); ?></span></a>
                                                        <?php elseif($stage->order == 5): ?>
                                                            <a href="<?php echo e(route('termination.index')); ?>"
                                                                class="dropdown-item"><i
                                                                    class="ti ti-eye "></i><span
                                                                    class="ms-2"><?php echo e(__('View Termination')); ?></span></a>
                                                        <?php elseif($stage->order == 6): ?>
                                                            <a href="<?php echo e(route('employee.show', \Crypt::encrypt($process->employee->id))); ?>"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <ul class="list-inline mb-0 mt-0">
                                                    ...
                                                    <?php if($stage->order == 2 && $process->access_removal_checklist): ?>
                                                        <?php
                                                    ...
                                                    <?php if($stage->order == 3 && $process->asset_collection_checklist): ?>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <li class="list-inline-item">
                                                            <small><?php echo e($assetCollected); ?>/<?php echo e($assetTotal); ?> Collected</small>
                                                        </li>
                                                    <?php endif; ?>

                                                    <?php if($stage->order == 4 && $process->settlement_status): ?>
                                                        <li class="list-inline-item">
                                                            <span class="badge bg-<?php echo e($process->settlement_status == 'completed' ? 'success' : 'warning'); ?>">
                                                                <?php echo e(ucfirst($process->settlement_status)); ?>
                        ...
                        if (timeDiff < 600000) { // 10 minutes in milliseconds
                            ...
                            setTimeout(function() {
                                ...
                                var confirmModalHtml = '<div class="modal fade" id="download-confirm-modal" tabindex="-1" role="dialog" aria-labelledby="downloadConfirmModalLabel" aria-hidden="true">' +
                                    ...
                                    '<h5 class="modal-title" id="downloadConfirmModalLabel"><?php echo e(__("Download Confirmation")); ?></h5>' +
                                    '<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>' +
                                    '</div>' +
                                    '<div class="modal-body">' +
                                    '<p class="mb-0"><?php echo e(__("Did you download something from the employee details page?")); ?></p>' +
                                    '</div>' +
                                    '<div class="modal-footer">' +
                                    '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="download-confirm-cancel"><?php echo e(__("No")); ?></button>' +
                                    '<button type="button" class="btn btn-primary" id="download-confirm-ok"><?php echo e(__("Yes")); ?></button>' +
                                    '</div>' +
                                    '</div></div></div>';
                                ...
                                $('#download-confirm-modal').on('hidden.bs.modal', function() {
                                    ...
                                    if (userClickedYes) {
                                        ...
                                        var stepUrl = '<?php echo e(url("offboarding")); ?>/' + processId + '/step/6';
                                        ...
                                        $.ajax({
                                            ...
                                            error: function() {
                                                show_toastr('Error', '<?php echo e(__("Unable to load confirmation form")); ?>', 'error');
                                                sessionStorage.removeItem('offboarding_employee_visit');
                                            }
                                        });
                                    }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HRM_Clearclaim\resources\views/offboarding/index.blade.php ENDPATH**/ ?>