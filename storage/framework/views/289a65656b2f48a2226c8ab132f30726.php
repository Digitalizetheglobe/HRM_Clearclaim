...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Logo Light Preview
            $('#company_logo_light').on('change', function(e) {
                if (this.files && this.files[0]) {
                    var reader = new FileReader();
                    reader.onload = function(e) {
            ...
            // Favicon Preview
            $('#company_favicon').on('change', function(e) {
                if (this.files && this.files[0]) {
                    var reader = new FileReader();
                    reader.onload = function(e) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HRM_Clearclaim\resources\views/setting/company_settings.blade.php ENDPATH**/ ?>