...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Termination')): ?>
        <a href="#" data-url="<?php echo e(route('termination.create')); ?>" data-ajax-popup="true"
            data-title="<?php echo e(__('Create New Relieve')); ?>" data-size="lg" data-bs-toggle="tooltip" title=""
                        ...
                        <table class="table" id="pc-dt-simple">
                            <thead>
                                <tr>
                                    ...
                                    <?php endif; ?>
                                    <th><?php echo e(__('Relieve Type')); ?></th>
                                    <th><?php echo e(__('Notice Date')); ?></th>
                                    <th><?php echo e(__('Relieve Date')); ?></th>
                                    <th><?php echo e(__('Description')); ?></th>
                                    <?php if(Gate::check('Edit Relieve') || Gate::check('Delete Relieve')): ?>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $terminations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $termination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'company')): ?>
                                            <td>
                                                <?php if($termination->employee): ?>
                                                    <?php echo e($termination->employee->name); ?>
                                        ...
                                        <td><?php echo e(!empty($termination->termination_type) && $termination->terminationType ? $termination->terminationType->name : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HRM_Clearclaim\resources\views/termination/index.blade.php ENDPATH**/ ?>